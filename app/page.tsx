  ...
  return (
    <>
      <div className="relative isolate min-h-screen overflow-hidden bg-[#F6F7FA]">
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 z-0 bg-[url('https://www.iiuc.ac.bd/assets/backpattern-SdO-ezZO.png')] bg-[length:920px_auto] bg-center bg-repeat opacity-[0.035] z-10"
        />
