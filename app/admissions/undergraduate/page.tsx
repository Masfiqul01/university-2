        ...
        <div className="relative mx-auto max-w-[1500px] overflow-hidden rounded-[28px] bg-[#150866] shadow-[0_18px_55px_rgba(21,8,102,0.18)]">
          ...
          <div className="relative flex min-h-[210px] flex-col justify-center px-7 py-9 sm:px-10 lg:flex-row lg:items-center lg:justify-between lg:px-14">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row lg:mt-0 lg:mr-8">
              ...
              <a
                href="#"
                className="group inline-flex min-w-[195px] items-center justify-center gap-3 rounded-full bg-white px-7 py-3.5 text-sm font-bold text-[#150866] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(255,255,255,0.12)]"
              >
              ...
              <a
                ...
                className="group inline-flex min-w-[195px] items-center justify-center gap-3 rounded-full border border-white/20 bg-white/[0.035] px-7 py-3.5 text-sm font-semibold text-white/75 transition-all duration-200 hover:border-white/40 hover:bg-white/[0.08] hover:text-white"
              >
                Explore Programs
