...
export default function FacilitiesPage() {
  return (
    <div className="min-h-screen bg-[#f5f8fc] text-[#102c4c]">
      ...
      ========================================================= */}
      <PageHeroBanner
        eyebrow={FACILITIES_HERO.eyebrow}
        titleLines={FACILITIES_HERO.titleLines}
        description={FACILITIES_HERO.description}
        image={FACILITIES_HERO.image}
        imageAlt={FACILITIES_HERO.imageAlt}
        primary={FACILITIES_HERO.primary}
        secondary={FACILITIES_HERO.secondary}
      />
