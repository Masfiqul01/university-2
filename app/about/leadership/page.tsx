...
const LEADERS = [
  {
    ...
    description:
      "Leading the university with a commitment to academic excellence, research and institutional growth.",
  ...
  },
  {
    ...
    description:
      "Supporting academic advancement, research initiatives and strategic development of the university.",
  ...
  },
  {
    ...
    description:
      "Overseeing financial management and ensuring transparency and accountability in all financial activities.",
