...
export function Hero({
  ...
  description = "KACST is committed to developing competent professionals and ethical leaders through quality education, research and innovation in an inspiring environment.",
  primaryCta = { label: "Explore Our Campus", href: "/campus-life" },
  secondaryCta = { label: "Learn More About KACST", href: "/about" },
  showActions = true,
  showSideLinks = true,
}: {
  eyebrow?: string
