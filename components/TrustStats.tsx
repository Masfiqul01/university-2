...
<section className="relative z-20 overflow-hidden border-b border-slate-200/80 bg-white py-14 sm:py-16 lg:py-20">
  ...
  {/* =====================================================
      BACKGROUND PATTERN — ONLY IMAGE OPACITY
  ===================================================== */}
  <div
  aria-hidden="true"
  className="pointer-events-none absolute inset-0 z-0 bg-[url('https://www.iiuc.ac.bd/assets/backpattern-SdO-ezZO.png')] bg-cover bg-center bg-no-repeat opacity-[0.06]"
/>
  ...
  <div className="relative z-10 mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
    ...
    <div className="mb-10 flex flex-col gap-8 lg:mb-12 lg:flex-row lg:items-end lg:justify-between">
      ...
      {/* =================================================
          UNIVERSITY IDENTITY
      ================================================= */}
      <div className="flex w-full items-center gap-4 rounded-2xl border border-slate-200 bg-slate-50/90 p-4 sm:p-5 lg:w-auto lg:min-w-[430px]">
